...
public class ACTaskViewController : ORKTaskViewController {
    ...
    public var questionnaireResponseJSON: [String: Any]? {
        return tsk.form.as_FHIRQuestionnaireResponse(with: score)
    }
    
    public var observationJSON: [String: Any]? {
        return tsk.form.as_FHIRObservation(with: score, related: nil, subject: nil)
    }
